...
# =============================================================================
#     #  TODO delete
#     # pred: (batch_size, grid, grid, anchors, (pbj, x, y, w, h, ...classes))
#     grid_size = tf.shape(pred)[1:3]
#     objectness, box_xy, box_wh, class_probs = tf.split(
#         pred, (1, 2, 2, classes), axis=-1)
# =============================================================================
...
def yolo_nms(outputs, anchors, masks, classes):
    ...
    selected_indices, selected_scores = tf.image.non_max_suppression_with_scores(
        ...
        soft_nms_sigma=yolo_soft_nms_sigma
    )
...
def YoloV3(size=None, channels=3, anchors=yolo_anchors,
           masks=yolo_anchor_masks, classes=80, training=False, yoloBoxOutputs=False):
    ...
    if yoloBoxOutputs:
        return Model(inputs, (boxes_0[:3], boxes_1[:3], boxes_2[:3]), name='yolov3')
...
def YoloLoss(anchors, classes=80, ignore_thresh=0.5):
    def yolo_loss(y_true, y_pred):
        ...
        # print('')
        # print(tf.stack([xy_loss, wh_loss, obj_loss, class_loss]))
