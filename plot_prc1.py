# -*- coding: utf-8 -*-
"""
Created on Tue Aug 30 15:19:23 2022
...
files = []
files.append('evaluation_classification/yolov3_sound_my_loss4_prc.json')
files.append('evaluation_classification/yolov3_sound_from_scratch16_prc.json')
files.append('evaluation_classification/yolov3_scratch_noiseAnchors__prc.json')
...
for key in letter:
    ...
    plt.savefig(folder + f'\\prc1_{key}.pdf', dpi=resolution, bbox_inches="tight")
